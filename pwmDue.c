...
// This is the 12-bit data array to feed the DAC0 or DAC1 into a specific rate.
...
void setup() {
  // declare all PWM pins to be an output:
  pinMode(13, OUTPUT);
  pinMode(12, OUTPUT);
  pinMode(11, OUTPUT);
  pinMode(10, OUTPUT);
...
void loop() {
  // set the brightness of all Arduino Due PWM pins
...
//  for (int i = 0; i == 120; i++)
//  {
//    analogWrite(DAC0, waveformsTable[1][value]);  // write the selected waveform on DAC0 from the array
//    analogWrite(DAC0, value);  // write the selected waveform on DAC0 from a simple value++ variable
//  }
  
  //analogWrite(DAC0, value );  
  value++;
  //delay(10); // wait for 10 milliseconds to see the dimming effect
  if(value>4096) // You most use 4096 value if you want to go from 0 to 4096 (12-bit max value) directly on DAC0 or DAC1
  //if(value>119) // You most use 119 if you want to use the 12-bit arrays, beacuase each array has 120 values
  value=0;
